...
EXTENDED_LIMIT_OFFSET = 0.03   # 3% offset for extended hours
...
def webhook():
    try:
        ...
        if signal == "OPEN_LONG":
            ...
            if regular:
                # Regular Trading Hours - Market Order
                api.submit_order(
                    symbol=symbol,
                    qty=qty,
                    side="buy",
                ...
                # Extended Hours - Limit Order with bigger offset
                ...
                try:
                    ...
                    print("Consider using market order fallback in extended hours", flush=True)
